...
namespace OrgMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        private async Task<bool> PostDepartmentAsync(Department department)
        {
            ...
            HttpResponseMessage response = await client.PostAsync("api/DeptTbls", content);
        ...
        private async Task<List<Department>> GetDepartmentAsync()
        {
            ...
            HttpResponseMessage response = await client.GetAsync("api/DeptTbls");
        ...
        private async Task<bool> UpdateDepartmentAsync(Department department)
        {
            ...
            HttpResponseMessage response = await client.PutAsync($"api/DeptTbls/{department.DeptId}", content);
